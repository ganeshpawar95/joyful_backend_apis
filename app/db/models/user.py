...
class User_shipping_address(ItemBase, table=True):  # Use table=True to indicate this is a table
    __tablename__ = "user_shipping_address"  # Optional, automatically inferred from the class name
